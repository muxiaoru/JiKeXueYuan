...
; (function ($, window, document) {
    ...
    $.fn.extend({
        paging: function (options) {
            ...
            //API 设置当前页
            PageAPI.SetCurrentPage = function (current_page) {
                return opts.currentPage = current_page;
            }
            ...
            //API 设置总页数
            PageAPI.SetTotalPage = function (total_page) {
                return opts.total = total_page;
            }
            ...
            if(url.split("=").length>1){
                opts.currentPage = parseInt(url.split("=")[1]);
            }else{
                opts.currentPage = 1;
            }
